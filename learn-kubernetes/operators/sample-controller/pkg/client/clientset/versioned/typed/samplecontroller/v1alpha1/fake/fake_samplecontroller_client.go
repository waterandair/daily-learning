...
import (
	v1alpha1 "github.com/waterandair/daily-learning/learn-kubernetes/operators/sample-controller/pkg/client/clientset/versioned/typed/samplecontroller/v1alpha1"
